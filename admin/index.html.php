...
<div class="container-fluid main-container">
    <div class="col-md-2 sidebar">
        <ul class="nav nav-pills nav-stacked">
            <li class="<?php if ($_GET['status'] == "all"){echo "active";}?>"><a href="?status=all">Toutes les demandes</a></li>
            <li class='<?php if ($_GET['status'] == "pending"){echo "active";}?>'><a href="?status=pending">En attentes de validation</a></li>
            <li class='<?php if ($_GET['status'] == "valid"){echo "active";}?>'><a href="?status=valid">Validé</a></li>
            <li class='<?php if ($_GET['status'] == "refuse"){echo "active";}?>'><a href="?status=refuse">Refusés</a></li>
        </ul>
    </div>
            ...
            <div class="panel-body">
                ...
                switch ($listing) {
                    ...
                    case 'pending':
                        ...
                        echo "<tr><th>Nom</th><th>Prénom</th><th>Adresse</th><th>Date d'inscription</th><th>Actions</th></tr>";
                        while ($donnee = $prep->fetch()) {
                            echo "<tr data-toggle='modal' data-target='.modal".$donnee['id']."'><td>" . $donnee['nom'] . "</td><td>" . $donnee['prenom'] . "</td><td>" . $donnee['adresse'] . "</td><td>" . $donnee['dateInsci'] . "</td><td><a href='traitement/action.php?status=1&id=" . $donnee['id'] . "'>Valider</a> <a href='traitement/action.php?status=2&id=" . $donnee['id'] . "'>Refuser</a></td></tr>";
                            echo "<div class=\"modal fade modal".$donnee['id']."\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\">
                                  <div class=\"modal-dialog modal-lg\" role=\"document\">
                                    <div class=\"modal-content\">
                                    <div class=\"modal-header\">
